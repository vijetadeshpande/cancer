...
%[PREVALENCE]=xlsread('C:\Users\Mike\Documents\Umass\Spring 2015\Cancer Research\excel\Data.xls');
...
%was using stage I-IV. Now Insitu-Distant July 11 2016
...
% Countries{1}=cell2mat(FORMAT(3,2));
% Countries{2}=cell2mat(FORMAT(3,3));
% Countries{3}=cell2mat(FORMAT(3,4));
% Countries{4}=cell2mat(FORMAT(3,5));
% Countries{5}=cell2mat(FORMAT(3,6));
% Countries{6}=cell2mat(FORMAT(3,7));
% Countries{7}=cell2mat(FORMAT(3,8));
% Countries{8}=cell2mat(FORMAT(3,9));
% Countries{9}=cell2mat(FORMAT(3,10));
% Countries{10}=cell2mat(FORMAT(3,11));
% Countries{11}=cell2mat(FORMAT(3,12));
% Countries{12}=cell2mat(FORMAT(3,13));
% Countries{13}=cell2mat(FORMAT(3,14));
% Countries{14}=cell2mat(FORMAT(3,15));
% Countries{15}=cell2mat(FORMAT(3,16));
% Countries
...
%     PAR{8}=AgeArrayU(I,:);
    ...
    [RES]=MarkovChainCountry2(PAR);
    
    [C_TEMPLATE]=WriteTemplate(RES,TEMPLATE);
    xlswrite('test.xls',C_TEMPLATE)
    'written'
    pause
